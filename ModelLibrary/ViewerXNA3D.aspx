...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value="XNA3D.xap"/>
          <param name="initParams" value="modelName=<%=Request["model"]%>,debug=<%=Request["debug"]%>,gallery=<%=Request["gallery"]%>,gallerySize=<%=Request["gallerySize"]%>"/>
